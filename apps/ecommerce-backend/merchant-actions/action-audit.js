...
exports.autoExpirePendingActions = autoExpirePendingActions;
exports.getActionById = getActionById;
exports.getActionSummaryKpis = getActionSummaryKpis;
exports.listActions = listActions;
const DB_1 = require("../data/DB");
function mapRowToAction(r) {
    var _a, _b, _c, _d;
    ...
    const rollbackMeta = execResult === null || execResult === void 0 ? void 0 : execResult.rollback;
    let outcome = null;
    if (r.impact_id || r.outcome_status) {
        ...
        outcome = {
            ...
            baselineMetrics: {
                stockOnHand: (_a = r.payload) === null || _a === void 0 ? void 0 : _a.stockAtRecommendation,
                velocity7d: (_b = r.payload) === null || _b === void 0 ? void 0 : _b.dailyVelocity7d,
                dailyRevenue: undefined,
                contributionMarginPct: undefined
            },
            expectedImpact: {
                expectedRevenueDelta: (_c = r.payload) === null || _c === void 0 ? void 0 : _c.expectedRevenueDelta,
                expectedUnitsDelta: r.quantity || ((_d = r.payload) === null || _d === void 0 ? void 0 : _d.reorderTargetUnits),
    ...
    return {
        ...
        canRollback,
        isReversible,
        rollbackAt: (rollbackMeta === null || rollbackMeta === void 0 ? void 0 : rollbackMeta.rolledBackAt) || (r.status === 'ROLLED_BACK' ? r.updated_at : null),
        rollbackBy: rollbackMeta === null || rollbackMeta === void 0 ? void 0 : rollbackMeta.rolledBackBy,
        outcome
    };
}
/**
 ...
 */
function autoExpirePendingActions() {
    return __awaiter(this, void 0, void 0, function* () {
        const res = yield DB_1.client.query(`UPDATE merchant_ai_actions 
     SET status = 'EXPIRED' 
...
function getActionById(actionId_1) {
    ...
    LIMIT 1;
  `;
        const res = yield DB_1.client.query(query, [actionId, merchantId]);
...
function getActionSummaryKpis() {
  ...
  `;
    ...
    WHERE merchant_id = $1 OR $1 = 'merchant_admin';
  `;
        const [res, impactRes] = yield Promise.all([
            DB_1.client.query(query, [merchantId]),
            DB_1.client.query(impactQuery, [merchantId])
        ]);
        const row = res.rows[0];
        const impactRow = impactRes.rows[0];
        const evaluated = (impactRow === null || impactRow === void 0 ? void 0 : impactRow.evaluated_count) || 0;
        const positive = (impactRow === null || impactRow === void 0 ? void 0 : impactRow.positive_count) || 0;
        ...
        return {
            ...
            totalVerifiedValueCreated: parseFloat((impactRow === null || impactRow === void 0 ? void 0 : impactRow.total_verified_value) || '0'),
...
function listActions() {
  ...
  `;
        const [listRes, kpis] = yield Promise.all([
            DB_1.client.query(listQuery, params),
