...
exports.cartQtyUpdate = exports.userUpdateSchema = exports.insertAddressSchema = exports.AddressUpdateSchema = exports.defaultUpdateSchema = void 0;
const express_validator_1 = require("express-validator");
const customValidation = (value, { req, location, path }) => {
    if (value === 'false') {
        return true; // Skip validation if 'false'
    }
    return value; // Continue with other validations if not 'false'
};
const userUpdateSchema = (0, express_validator_1.checkSchema)({
    userName: {
        in: ['body'],
        custom: {
...
const AddressUpdateSchema = (0, express_validator_1.checkSchema)({
    userID: {
        in: ['body'],
        isInt: true,
        isLength: { options: { min: 1, max: 10 } },
...
const insertAddressSchema = (0, express_validator_1.checkSchema)({
    addressType: {
        in: ['body'],
        isString: true,
        notEmpty: true,
...
exports.insertAddressSchema = insertAddressSchema;
const defaultUpdateSchema = (0, express_validator_1.checkSchema)({
    addressID: {
        in: ['body'],
        isInt: true,
        isLength: { options: { min: 1, max: 10 } },
...
exports.defaultUpdateSchema = defaultUpdateSchema;
const cartQtyUpdate = (0, express_validator_1.checkSchema)({
    cartItemID: {
        in: ['body'],
...
exports.cartQtyUpdate = cartQtyUpdate;
