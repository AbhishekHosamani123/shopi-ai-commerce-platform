...
exports.capitalAllocationEngine = exports.CapitalAllocationEngine = void 0;
...
class CapitalAllocationEngine {
     ...
     */
    allocateCapital() {
        return __awaiter(this, arguments, void 0, function* (totalBudget = 100000, merchantId = 'default_merchant') {
            var _a;
    ...
    `);
            const atRiskCount = ((_a = custRes.rows[0]) === null || _a === void 0 ? void 0 : _a.at_risk_count) || 12;
            ...
            opportunities.push({
                ...
                title: `Inventory Replenishment: ${(topProd === null || topProd === void 0 ? void 0 : topProd.title) || 'Fast-Moving SKU'}`,
                recommendedAmount: restock1Amt,
                allocationPercentage: 40,
                expectedPaybackPeriodDays: 28,
                expectedImpact: `Replenishes ~${Math.max(15, Math.round(restock1Amt / parseFloat((topProd === null || topProd === void 0 ? void 0 : topProd.price) || '1200')))} units. Prevents estimated ₹${Math.round(restock1Amt * 1.6).toLocaleString('en-IN')} in lost stockout revenue.`,
                confidence: 'HIGH',
                risk: 'LOW',
                targetSkuId: topProd === null || topProd === void 0 ? void 0 : topProd.productid,
                targetSkuTitle: topProd === null || topProd === void 0 ? void 0 : topProd.title,
            ...
            opportunities.push({
                category: 'RESTOCK_HIGH_VELOCITY',
                title: `Secondary Line Safety Stock: ${(secondProd === null || secondProd === void 0 ? void 0 : secondProd.title) || 'Core Catalog Line'}`,
                recommendedAmount: restock2Amt,
                allocationPercentage: 25,
                expectedPaybackPeriodDays: 35,
                expectedImpact: `Buffers ~${Math.max(10, Math.round(restock2Amt / parseFloat((secondProd === null || secondProd === void 0 ? void 0 : secondProd.price) || '1000')))} units against sudden regional demand spikes.`,
                confidence: 'HIGH',
                risk: 'LOW',
                targetSkuId: secondProd === null || secondProd === void 0 ? void 0 : secondProd.productid,
                targetSkuTitle: secondProd === null || secondProd === void 0 ? void 0 : secondProd.title,
                actionRequired: 'Draft Purchase Order',
...
exports.capitalAllocationEngine = new CapitalAllocationEngine();
