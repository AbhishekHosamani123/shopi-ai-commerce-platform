...
exports.channelAllocationEngine = exports.ChannelAllocationEngine = void 0;
...
class ChannelAllocationEngine {
    ...
    `);
            ...
            for (const p of prodRes.rows) {
                ...
                const primary = ((_a = channels[0]) === null || _a === void 0 ? void 0 : _a.channel) || 'DIRECT_STORE';
...
exports.ChannelAllocationEngine = ChannelAllocationEngine;
exports.channelAllocationEngine = new ChannelAllocationEngine();
