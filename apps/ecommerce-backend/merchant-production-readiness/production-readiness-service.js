...
exports.productionReadinessService = exports.ProductionReadinessService = void 0;
const observability_service_1 = require("../merchant-observability/observability-service");
class ProductionReadinessService {
    ...
    evaluateProductionReadiness() {
        return __awaiter(this, arguments, void 0, function* (merchantId = 'default_merchant') {
            const obs = yield observability_service_1.observabilityService.getObservabilityMetrics(merchantId);
            const categories = [
                {
                    category: 'SECURITY',
...
exports.ProductionReadinessService = ProductionReadinessService;
exports.productionReadinessService = new ProductionReadinessService();
