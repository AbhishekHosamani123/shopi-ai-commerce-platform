...
exports.liveSyncEngine = exports.LiveSyncEngine = void 0;
...
class LiveSyncEngine {
     ...
     */
    discoverStoreMetadata(connector) {
        return __awaiter(this, void 0, void 0, function* () {
            const [pRes, oRes, cRes] = yield Promise.all([
     ...
     */
    runInitialSync(connector_1, merchantId_1) {
        return __awaiter(this, arguments, void 0, function* (connector, merchantId, batchSize = 50, resumeSyncId) {
    ...
    `, [syncId, merchantId, connector.provider]);
            try {
                ...
                const pCheckpoint = yield this.getCheckpoint(syncId, 'PRODUCTS');
                if (pCheckpoint && !pCheckpoint.isComplete) {
                    prodPage = pCheckpoint.pageNumber;
                }
                while (prodHasMore) {
                    const pRes = yield connector.getProducts({ page: prodPage, limit: batchSize });
            ...
            `, [
                ...
                const cCheckpoint = yield this.getCheckpoint(syncId, 'CUSTOMERS');
                if (cCheckpoint && !cCheckpoint.isComplete) {
                    custPage = cCheckpoint.pageNumber;
                }
                while (custHasMore) {
                    const cRes = yield connector.getCustomers({ page: custPage, limit: batchSize });
            ...
            `, [
                ...
                let ordPage = 1;
                let ordHasMore = true;
                const oCheckpoint = yield this.getCheckpoint(syncId, 'ORDERS');
                if (oCheckpoint && !oCheckpoint.isComplete) {
                    ordPage = oCheckpoint.pageNumber;
                }
                while (ordHasMore) {
                    const oRes = yield connector.getOrders({ page: ordPage, limit: batchSize });
            ...
            `, [
                ...
                // ----------------------------------------------------
                const dbReconRes = yield DB_1.client.query(`
        SELECT 
      ...
      `, [totalProductsImported, totalCustomersImported, totalOrdersImported, merchantId, connector.provider]);
                ...
                yield DB_1.client.query('ROLLBACK').catch(() => { });
                const safeErr = credential_vault_1.credentialVault.sanitizeError(err);
     ...
     */
    runIncrementalSync(connector, merchantId, since) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            ...
            const oRes = yield connector.getOrders({ updatedSince: since, limit: 100 });
            yield DB_1.client.query('BEGIN');
            try {
                for (const ord of oRes.data) {
    ...
    getCheckpoint(syncId, entityType) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield DB_1.client.query(`
...
exports.LiveSyncEngine = LiveSyncEngine;
exports.liveSyncEngine = new LiveSyncEngine();
