...
exports.LocalTestMerchantServer = void 0;
 ...
 */
class LocalTestMerchantServer {
    constructor(port = 3899) {
        this.server = null;
        this.validBearerToken = 'mock_ext_token_sec_2026_test';
        ...
        this.rateLimitTriggerCount = 0;
        this.transientErrorCountdown = 0;
        this.port = port;
    ...
    setupRoutes() {
        ...
        // Paginated Customers
        this.app.get('/api/v1/customers', (req, res) => {
            const page = parseInt(req.query.page || '1', 10);
            const limit = parseInt(req.query.limit || '50', 10);
            const since = req.query.since ? new Date(req.query.since) : null;
        ...
        // Paginated Orders
        this.app.get('/api/v1/orders', (req, res) => {
            const page = parseInt(req.query.page || '1', 10);
            const limit = parseInt(req.query.limit || '50', 10);
            const since = req.query.since ? new Date(req.query.since) : null;
        ...
        // Order Items
        this.app.get('/api/v1/orders/:orderId/items', (req, res) => {
            const orderId = req.params.orderId;
            const items = this.orderItems.filter(i => i.externalOrderId === orderId);
            res.json({ data: items });
        });
        // Paginated Inventory
        this.app.get('/api/v1/inventory', (req, res) => {
            const page = parseInt(req.query.page || '1', 10);
            const limit = parseInt(req.query.limit || '50', 10);
            const startIndex = (page - 1) * limit;
        ...
        // Paginated Returns
        this.app.get('/api/v1/returns', (req, res) => {
            const page = parseInt(req.query.page || '1', 10);
            const limit = parseInt(req.query.limit || '50', 10);
            const startIndex = (page - 1) * limit;
        ...
        // Paginated Payments
        this.app.get('/api/v1/payments', (req, res) => {
            const page = parseInt(req.query.page || '1', 10);
            const limit = parseInt(req.query.limit || '50', 10);
            const startIndex = (page - 1) * limit;
        ...
        this.app.post('/api/v1/test/inject-incremental', (req, res) => {
...
exports.LocalTestMerchantServer = LocalTestMerchantServer;
