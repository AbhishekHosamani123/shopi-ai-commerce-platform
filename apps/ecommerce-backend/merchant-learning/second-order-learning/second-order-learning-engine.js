...
exports.secondOrderLearningEngine = exports.SecondOrderLearningEngine = void 0;
class SecondOrderLearningEngine {
    /**
     * Measures realized second-order consequences of approved merchant actions against predicted effects.
     */
    evaluateSecondOrderConsequences(decisionId = 'dec_demo') {
...
exports.SecondOrderLearningEngine = SecondOrderLearningEngine;
exports.secondOrderLearningEngine = new SecondOrderLearningEngine();
