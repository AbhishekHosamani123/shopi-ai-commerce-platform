export interface LearningExplanation {
  ...
  previousModelAccuracy: string;
  whatChanged: string;
  whyDifferFromBefore: string;
  confidence: 'HIGH' | 'MEDIUM' | 'LOW';
}

export class LearningExplainer {
  /**
   * Generates a comprehensive 6-point explainability response for any learned parameter or recommendation change.
   */
  explainLearning(topic: string = 'PRICING_ELASTICITY'): LearningExplanation {
...
export const learningExplainer = new LearningExplainer();
