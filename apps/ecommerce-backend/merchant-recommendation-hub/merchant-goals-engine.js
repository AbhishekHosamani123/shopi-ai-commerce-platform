...
exports.merchantGoalsEngine = exports.MerchantGoalsEngine = void 0;
const DB_1 = require("../data/DB");
class MerchantGoalsEngine {
    /**
     ...
     */
    setActiveGoal(goal_1, targetDescription_1) {
        return __awaiter(this, arguments, void 0, function* (goal, targetDescription, deadlineDays = 30, merchantId = 'default_merchant') {
            const defaultDesc = {
     ...
     */
    rankRecommendationsByGoal(recommendations, goal) {
        ...
        return [...recommendations].map(rec => {
            ...
            return Object.assign(Object.assign({}, rec), { priorityScore: adjustedScore });
        }).sort((a, b) => b.priorityScore - a.priorityScore);
    }
}
exports.MerchantGoalsEngine = MerchantGoalsEngine;
exports.merchantGoalsEngine = new MerchantGoalsEngine();
