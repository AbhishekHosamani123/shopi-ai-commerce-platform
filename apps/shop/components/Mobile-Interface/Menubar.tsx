...
const Menubar = () => {
  ...
  return (
    <>
      <Sidebar/>
      <div className='flex fixed bg-white h-14 bottom-0 z-40 justify-evenly shadow-top min-w-[230px] w-full max-w-[500px] flex-shrink-1 rounded-t-xl lg:hidden items-center'>
        ...
        <Link href='/' prefetch={true} className="flex items-center"><HomeIcon width={30}/></Link>
