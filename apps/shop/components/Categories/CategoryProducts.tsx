...
const CategoryProductCardSkeleton = () => (
  <div className="flex flex-col border border-slate-100 rounded-xl w-[220px] p-2 space-y-3 animate-pulse bg-white">
  ...
  return (
    <div className="sm:ml-4 ml-auto mr-auto pb-8 max-w-[980px] flex flex-col flex-1">
      ...
      <div className="flex flex-wrap mt-8 gap-5 justify-center xl:w-[980px] lg:w-[720px] max-w-[980px] flex-1 relative">
        ...
        {dataChecked && !loading && products.map((each, index) => (
